...
def test_create_node():
    ...
    r = client.post("/graph/nodes", json=payload)
...
def test_create_edge():
    # create nodes first
    r_a = client.post("/graph/nodes", json={
        "id": "edge_a",
        "title": "Edge A",
        "year": 2020,
        "authors": ["A"],
    ...
    r_b = client.post("/graph/nodes", json={
        "id": "edge_b",
        "title": "Edge B",
        "year": 2021,
        "authors": ["B"],
    ...
    r = client.post("/graph/edges", json={
        "type": "REFINES",
        "from_id": "edge_a",
        "to_id": "edge_b",
        "timestamp": 2021,
...
def test_snapshot_filters_future_edges():
    ...
    r1 = client.get("/graph/nodes/everett1957/neighborhood", params={"year": 1957})
    ...
    r_new = client.post("/graph/edges", json={
        "type": "RESONATES_WITH",
        "from_id": "everett1957",
        "to_id": "qbism",
        "timestamp": 2099,
    ...
    r2 = client.get("/graph/nodes/everett1957/neighborhood", params={"year": 2025})
